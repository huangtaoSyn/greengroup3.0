...
public interface TSwitchMapper {
	...
	public List<T10Switch> findT10Switch11();
	public List<T11Switch> findT11Switch11();
	public List<T15Switch> findT15Switch11();
	public List<T16Switch> findT16Switch11();
	public List<T17Switch> findT17Switch11();
	public List<T18Switch> findT18Switch11();
	public List<T19Switch> findT19Switch11();
	public List<T21Switch> findT21Switch11();
	public List<T22Switch> findT22Switch11();
	public List<T24Switch> findT24Switch11();
	public List<T26Switch> findT26Switch11();
	public List<T27Switch> findT27Switch11();
	public List<T28Switch> findT28Switch11();
	public List<T29Switch> findT29Switch11();
	public List<T30Switch> findT30Switch11();
	public List<T40Switch> findT40Switch11();
	public List<T41Switch> findT41Switch11();
	public List<T42Switch> findT42Switch11();
	public List<T43Switch> findT43Switch11();
	public List<T44Switch> findT44Switch11();

	public List<ResultDevice> findDefinedData(@Param("did") int did ,@Param("pid") int pid);
